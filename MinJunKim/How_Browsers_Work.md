...
렌더링 엔진의 동작 원리   
<img src="https://user-images.githubusercontent.com/101058125/187609676-29d8b459-b8e8-4e76-9c97-1d5d331df2f9.png" width="40%" height="30%" title="px(픽셀) 크기 설정" alt=""></img>
이는 렌더링 엔진의 크게 나눈 동작 과정으로, 각 단계에 해당하는 설명을 더 세부적이게 나누어 아래에 할 예정



- 웹킷 엔진(크롬, 사파리용 렌더링 엔진)의 세부적인 과정 예시
<img src="https://user-images.githubusercontent.com/101058125/187609692-7b19335e-1afa-49ae-8bbf-788ef2fc8d2f.png" width="40%" height="30%" title="px(픽셀) 크기 설정" alt=""></img>
